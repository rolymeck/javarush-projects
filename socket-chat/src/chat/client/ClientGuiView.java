...
public class ClientGuiView {
    ...
    private final JFrame frame = new JFrame("Чат"); // пустое окно с заголовком "Чат"
    private final JTextField textField = new JTextField(50); // пустое поле "textField" в которое может поместиться 50 символов
    private final JTextArea messages = new JTextArea(10, 50); // пустое поле "messages" высотой в 10 символов, шириной - 50
    private final JTextArea users = new JTextArea(10, 10); // тоже самое, поле "users"
    ...
    private void initView() {
        ...
        textField.addActionListener(e -> { // добавляем действие
